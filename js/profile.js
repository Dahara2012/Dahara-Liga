...
async function generateProfile(id) {
    let [template, resultEntries1, resultEntries2, resultEntries3, resultEntries4, resultEntries5, resultEntries6] = await Promise.all([getTemplate('profile.html'), getProfile(id), getPodiums(id), getFahrerGesamtPunkte(id), getCurrentGesamtStrafpunkte(id), getCurrentStrafpunkteListe(id), getLastRacesListe(id)]);
